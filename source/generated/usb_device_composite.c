...
extern usb_status_t USB_DeviceInterface2MscRamDiskInit(usb_device_composite_struct_t *deviceComposite);
extern usb_status_t USB_DeviceInterface2MscRamDiskCallback(class_handle_t handle, uint32_t event, void *param);
extern usb_status_t USB_DeviceInterface2MscRamDiskSetConfiguration(class_handle_t handle, uint8_t configuration_index);
extern usb_status_t USB_DeviceInterface2MscRamDiskSetInterface(class_handle_t handle, uint8_t alternateSetting);
...
extern usb_device_class_struct_t g_UsbDeviceInterface2MscRamDiskConfig;
...
usb_device_class_config_struct_t g_CompositeClassConfig[USB_COMPOSITE_INTERFACE_COUNT] = {
    ...
    {
        USB_DeviceInterface2MscRamDiskCallback, (class_handle_t)NULL, &g_UsbDeviceInterface2MscRamDiskConfig,
    },
};
    ...
    (defined(USB_DEVICE_CONFIG_KHCI) && (USB_DEVICE_CONFIG_KHCI > 0U))
        ...
        case kUSB_DeviceEventSetConfiguration:
            if (0 == (*temp8))
            {
                ...
                /* The device is detached - the zero configuration is set. */
                USB_DeviceInterface2MscRamDiskSetConfiguration(g_UsbDeviceComposite.interface2MscRamDiskHandle, *temp8);
                error = kStatus_USB_Success;
            }
...
usb_status_t USB_UpdateInterfaceSetting(uint8_t interface, uint8_t alternateSetting)
{
    ...
    case USB_INTERFACE_2_MSC_RAM_DISK_INDEX:
        ret = USB_DeviceInterface2MscRamDiskSetInterface(g_UsbDeviceComposite.interface2MscRamDiskHandle, alternateSetting);
        break;
    }
...
usb_status_t USB_DeviceApplicationInit(void)
{
    ...
    g_UsbDeviceComposite.interface2MscRamDiskHandle = (class_handle_t)NULL;
    ...
    g_UsbDeviceComposite.interface2MscRamDiskHandle = g_UsbDeviceCompositeConfigList.config[2].classHandle;
    USB_DeviceInterface2MscRamDiskInit(&g_UsbDeviceComposite);
