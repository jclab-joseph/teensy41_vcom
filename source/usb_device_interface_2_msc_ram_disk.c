 ...
 */
usb_status_t USB_DeviceInterface2MscRamDiskCallback(class_handle_t handle, uint32_t event, void *param)
{
 ...
 */
usb_status_t USB_DeviceInterface2MscRamDiskSetConfiguration(class_handle_t handle, uint8_t configuration_idx)
{
   return kStatus_USB_Success;
}
 ...
 * @return kStatus_USB_Success.
 */
usb_status_t USB_DeviceInterface2MscRamDiskSetInterface(class_handle_t handle, uint8_t alternateSetting)
{
   return kStatus_USB_Success;
}
 ...
 * @return kStatus_USB_Success.
 */
usb_status_t USB_DeviceInterface2MscRamDiskInit(usb_device_composite_struct_t *deviceComposite)
{
    return kStatus_USB_Success;
}
